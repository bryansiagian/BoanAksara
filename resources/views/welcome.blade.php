...
@section('content')
    ...
    <script>
        ...
        const aksaraMap = {
            'a': 'ᯀ', 'ba': 'ᯅ', 'ca': 'ᯘ', 'da': 'ᯖ', 'ga': 'ᯎ', 'ha': 'ᯄ', 'ja': 'ᯐ', 'ka': 'ᯂ',
            'la': 'ᯞ', 'ma': 'ᯔ', 'na': 'ᯉ', 'pa': 'ᯇ', 'ra': 'ᯒ', 'sa': 'ᯘ', 'ta': 'ᯖ', 'wa': 'ᯋ',
            'ya': 'ᯛ', 'za': 'ᯗ', 'i': 'ᯪ', 'u': 'ᯮ', 'e': 'ᯇᯩ', 'o': 'ᯅᯬ',
            'ai': 'ᯅᯤ', 'au': 'ᯅᯥ', // Contoh diftong
            'ang': 'ᯀᯰ', 'ing': 'ᯤᯰ', 'ung': 'ᯄᯰ', 'eng': 'ᯇᯩᯰ', 'ong': 'ᯅᯬᯰ', // Contoh vokal + 'ng'
            'ar': 'ᯀᯒ᯲', 'ir': 'ᯤᯒ᯲', 'ur': 'ᯄᯒ᯲', 'er': 'ᯇᯩᯒ᯲', 'or': 'ᯅᯬᯒ᯲', // Contoh vokal + 'r'
            // ... tambahkan semua kombinasi yang diperlukan
        };
